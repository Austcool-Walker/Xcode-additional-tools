...
Screen Savers					Composition examples of screen savers.
...
Sample Requirements				The supplied Quartz Composer compositions were created 
						...
						patches, OpenCL-capable hardware is required.

About the sample				Compositions that show how to use Quartz Composer to 
						generate screen savers.
