...
Graphic Transitions				Composition examples that generate image transitions.

Sample Requirements				The supplied Quartz Composer compositions were created 
						using the Quartz Composer editor running under Mac OS X 
						10.6.x or later and for compositions that use OpenCL, 
						OpenCL-capable hardware is required.

About the sample				Compositions that show how to generate transitions from 
						source image to destination image in Quartz Composer.
